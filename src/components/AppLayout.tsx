    ...
    <SidebarProvider>
      ...
      <div className="min-h-[100dvh] flex w-full bg-[radial-gradient(circle_at_20%_20%,rgba(34,197,94,0.06),transparent_40%),#020617]">
        ...
        <div className="flex-1 flex flex-col min-w-0 bg-[sidebar-accent-foreground] bg-background pt-0">
          ...
          <header
            className="h-[64px] flex items-center justify-between md:px-6 border-b border-white/5 backdrop-blur-2xl sticky top-0 z-40 px-[10px] gap-0 my-[10px] py-[5px] border-4 bg-background border-none rounded-none pb-[10px] pt-[30px]">
          ...
          <main
            className="flex-1 overflow-y-auto px-4 pb-[120px] md:px-8 border-2 border-popover pt-[20px] mx-0">

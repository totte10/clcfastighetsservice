...
<div className="backdrop-blur-xl shadow-black/40 flex justify-between items-center px-6 py-3 text-primary-foreground shadow-2xl border-zinc-950 border-2 border-solid rounded-xl bg-zinc-800">

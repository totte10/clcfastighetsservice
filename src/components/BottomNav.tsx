...
<div className="backdrop-blur-xl shadow-black/40 flex justify-between items-center px-6 py-3 text-primary-foreground border-solid bg-zinc-800 mb-[10px] rounded-2xl shadow-2xl border-4 border-zinc-900">

...
<div className="backdrop-blur-xl shadow-black/40 flex justify-between items-center py-3 text-primary-foreground shadow-2xl border-2 border-solid rounded-xl border-zinc-700 px-[24px] bg-zinc-700/[0.61]">

...
<div ref={ref} className={cn("bg-[sidebar-accent-foreground] text-primary-foreground border-solid mx-0 px-[20px] rounded-lg shadow-none border-2 pt-[10px] pb-[10px] border-zinc-600 py-[20px] my-[20px] bg-zinc-600", className)} {...props} />
);

    ...
    <div className="min-h-screen flex items-center justify-center p-4 border-muted bg-sidebar">
      <Card className="w-full max-w-sm glass-card">
        <CardContent className="pt-8 pb-8 flex flex-col items-center gap-6">
          <img alt="CLC" className="w-16 h-16 rounded-xl object-contain" src="/clc-logo.png" />
          ...
          <form onSubmit={handleUsernameLogin} className="w-full space-y-3">
            ...
            <Button type="submit" disabled={loading || !username.trim() || !password.trim()} className="w-full gap-2" size="lg">
